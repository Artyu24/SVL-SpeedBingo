...
tag @a[tag=BingoTetes_Running,tag=!BingoModule_B1_Playing] remove BingoTetes_Running
...
execute if entity @a[gamemode=adventure,tag=BingoModule_B1_Playing] run function sb:module/tetes/tetes_game {teamA:"Albertos",teamB:"RTT",caseName:"B1",answer:"16"}
