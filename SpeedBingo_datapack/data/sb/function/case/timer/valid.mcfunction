...
$tellraw @p[distance=..10, gamemode=adventure] ["",{color:"gray",text:"["},{color:"#fffb00",text:"S"},{color:"#fff100",text:"p"},{color:"#ffe700",text:"e"},{color:"#ffdc00",text:"e"},{color:"#ffd200",text:"d "},{color:"#ffbe00",text:"B"},{color:"#ffb400",text:"i"},{color:"#ffa900",text:"n"},{color:"#ff9f00",text:"g"},{color:"#ff9500",text:"o"},{color:"gray",text:"]"}," - ",{color:"gray",text:"["},{color:"yellow",text:"$(caseName)"},{color:"gray",text:"]"}," Tu as fais un temps de ",{score:{name:"@p[distance=..10, gamemode=adventure]",objective:"BingoTimer_Second"},color:"yellow"},{color:"yellow",text:"s"}]
...
$execute if score #$(caseName) BingoTimer_Saved > @p[distance=..10, gamemode=adventure] BingoTimer_Second run return run function sb:case/timer/valid_withteam {teamWin:"$(teamWin)", teamLose:"$(teamLose)", caseName:"$(caseName)", colorBlock:"$(colorBlock)", colorText:"$(colorText)"}