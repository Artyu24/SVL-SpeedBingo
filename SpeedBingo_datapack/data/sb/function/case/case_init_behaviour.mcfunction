...
$kill @e[distance=..10, type=minecraft:item_display, tag=TeamDisplay_$(caseName)]

$summon minecraft:marker ~ ~1 ~ {Tags:[$(caseName),"BingoCase"]}
...
execute positioned ~ ~1 ~ run fill ~-2 ~-2 ~ ~2 ~2 ~ minecraft:air replace minecraft:white_stained_glass
