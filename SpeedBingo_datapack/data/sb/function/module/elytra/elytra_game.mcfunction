...
$execute as @a[distance=..100,tag=BingoModule_$(caseName)_Playing,tag=!BingoModule_ElytraWarn] run title @s actionbar [{text:"Elytra : ",color:"white"},{score:{name:"#AlbertosScore",objective:"BingoScore_Elytra"},color:"aqua"},{text:" - ",color:"gray"},{score:{name:"#RTTScore",objective:"BingoScore_Elytra"},color:"green"}]
