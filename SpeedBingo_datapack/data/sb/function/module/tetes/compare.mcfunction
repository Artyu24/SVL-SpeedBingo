...
$execute if score #$(teamA) BingoValid_Tetes matches 1 if score #$(teamB) BingoValid_Tetes matches 1 if score #$(teamA) BingoTime_Tetes < #$(teamB) BingoTime_Tetes run function sb:case/case_validation {teamWin:"$(teamA)",teamLose:"$(teamB)",caseName:"$(caseName)",color:"$(colorA)"}
$execute if score #$(teamA) BingoValid_Tetes matches 1 if score #$(teamB) BingoValid_Tetes matches 1 if score #$(teamB) BingoTime_Tetes < #$(teamA) BingoTime_Tetes run function sb:case/case_validation {teamWin:"$(teamB)",teamLose:"$(teamA)",caseName:"$(caseName)",color:"$(colorB)"}

# Egalite exacte ou deux mauvaises reponses : aucune equipe ne gagne la case.
$execute if score #$(teamA) BingoValid_Tetes matches 1 if score #$(teamB) BingoValid_Tetes matches 1 if score #$(teamA) BingoTime_Tetes = #$(teamB) BingoTime_Tetes run tellraw @a {"text":"Egalite parfaite au module Tetes.","color":"yellow"}
