...
$tag @p[tag=BingoModule_$(caseName)_Playing,tag=BingoTimerTick,distance=..40,sort=nearest,limit=1] add BingoAirship_$(instance)_Success
...
$execute as @a[tag=BingoAirship_$(instance)_Success,limit=1] at @s run function sb:case/case_finish_behaviour {caseName:"$(caseName)"}
