...
execute if score @s BingoMMExact matches 5 run tellraw @s [{"text":"[Mastermind] ","color":"gold"},{"text":"Combinaison trouvée ! Prends la plaque en or pour sortir.","color":"green"}]
