...
execute as @e[type=minecraft:item,distance=..40] if items entity @s contents #sb:mastermind_wools[!minecraft:custom_data~{BingoZipItem:1}] run data modify entity @s Item.components."minecraft:custom_data" set value {BingoZipItem:1}
