...
execute as @e[type=minecraft:item,distance=..40] if items entity @s contents #sb:mastermind_wools[!minecraft:custom_data~{sb_module:"mastermind"}] run data modify entity @s Item.components."minecraft:custom_data" set value {sb_module:"mastermind"}
