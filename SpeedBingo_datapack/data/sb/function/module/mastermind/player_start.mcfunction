...
$execute unless entity @e[type=minecraft:marker,tag=BingoMastermind_$(instance)_Answer1,scores={BingoMMColor=1..11},limit=1] run scoreboard players set @s BingoMMValid 0
$execute unless entity @e[type=minecraft:marker,tag=BingoMastermind_$(instance)_Answer2,scores={BingoMMColor=1..11},limit=1] run scoreboard players set @s BingoMMValid 0
$execute unless entity @e[type=minecraft:marker,tag=BingoMastermind_$(instance)_Answer3,scores={BingoMMColor=1..11},limit=1] run scoreboard players set @s BingoMMValid 0
$execute unless entity @e[type=minecraft:marker,tag=BingoMastermind_$(instance)_Answer4,scores={BingoMMColor=1..11},limit=1] run scoreboard players set @s BingoMMValid 0
$execute unless entity @e[type=minecraft:marker,tag=BingoMastermind_$(instance)_Answer5,scores={BingoMMColor=1..11},limit=1] run scoreboard players set @s BingoMMValid 0
